	...
	internal class PluginInfoCache
	{
        ...
        public static PluginInfoCache Read(string file) {
            ...
            using (var fs = new FileStream(file, FileMode.Open, FileAccess.Read, FileShare.Read)) {
                // Deserialize the JSON data from the file stream
                return JsonSerializer.Deserialize<PluginInfoCache>(fs);
            }
        }
        ...
        public void Write(string file) {
            ...
            using (var fs = new FileStream(file, FileMode.Create, FileAccess.Write, FileShare.None)) {
                // Serialize the JSON data to the file stream
                var options = new JsonSerializerOptions {
                    WriteIndented = true, // For readable formatting
                    IncludeFields = true // If your class has public fields instead of properties
                };
