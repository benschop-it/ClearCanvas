...
namespace ClearCanvas.Healthcare
{
	...
	public sealed partial class OrderAttachment : ValueObject, IEquatable<OrderAttachment>, IAuditFormattable
	{
	  	...
	  	/// </summary>
	  	public OrderAttachment(ClearCanvas.Healthcare.OrderAttachmentCategoryEnum category1, ClearCanvas.Healthcare.Staff attachedby1, DateTime attachedtime1, ClearCanvas.Healthcare.AttachedDocument document1)
	  	{
		  	CustomInitialize();
	  	...
	  	public bool Equals(OrderAttachment that)
		{
			return (that != null) &&
				...
				EqualityUtils<ClearCanvas.Healthcare.OrderAttachmentCategoryEnum>.AreEqual(this._category, that._category) &&
