...
namespace ClearCanvas.Enterprise.Authentication
{
	...
	public partial class UserSearchCriteria : EntitySearchCriteria<User>
	{
		...
		public override object Clone()
        {
	  	...
	  	public ISearchCondition<ClearCanvas.Enterprise.Authentication.UserAccountType> AccountType
	  	{
	  		get
	  		{
	  			if(!this.SubCriteria.ContainsKey("AccountType"))
	  			{
	  				this.SubCriteria["AccountType"] = new SearchCondition<ClearCanvas.Enterprise.Authentication.UserAccountType>("AccountType");
	  			}
	  			return (ISearchCondition<ClearCanvas.Enterprise.Authentication.UserAccountType>)this.SubCriteria["AccountType"];
	  		}
	  	}
	  	...
	  	public ISearchCondition<string> EmailAddress
	  	{
	  		get
	  		{
	  			if(!this.SubCriteria.ContainsKey("EmailAddress"))
	  			{
	  				this.SubCriteria["EmailAddress"] = new SearchCondition<string>("EmailAddress");
	  			}
	  			return (ISearchCondition<string>)this.SubCriteria["EmailAddress"];
	  		}
	  	}
