	...
	public sealed partial class Password : ValueObject, IEquatable<Password>, IAuditFormattable
	{
	  	...
	  	public bool Equals(Password that)
		{
			return (that != null) &&
				...
				EqualityUtils<string>.AreEqual(this._salt, that._salt) &&
			
				EqualityUtils<string>.AreEqual(this._saltedHash, that._saltedHash) &&
			
				EqualityUtils<DateTime?>.AreEqual(this._expiryTime, that._expiryTime) &&
