...
namespace ClearCanvas.Enterprise.Configuration
{
	...
	public  partial class ConfigurationDocument : ClearCanvas.Enterprise.Core.Entity
	{
	  	...
	  	/// </summary>
	  	public ConfigurationDocument(string documentname1, string documentversionstring1, string user1, string instancekey1, DateTime creationtime1, ClearCanvas.Enterprise.Configuration.ConfigurationDocumentBody body1)
			:base()
	  	{
		  	CustomInitialize();
